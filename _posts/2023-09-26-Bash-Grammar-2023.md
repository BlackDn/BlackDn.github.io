...
我们去命令行执行它（如果出现`permission denied`，则说明这个.sh脚本文件没有执行权限，使用chmod为其添加执行权限即可，具体权限问题可以查看[Linux权限及chmod命令](https://blackdn.github.io/2023/10/10/Linux-User-and-System-2023/#linux%E6%9D%83%E9%99%90%E5%8F%8Achmod%E5%91%BD%E4%BB%A4)  
...
3. [curl官方文档](https://curl.se/docs/manpage.html)
