...
更新：因为这篇文章对Bash语法涉及甚少，涉及的知识都是为了实现实例的脚本而介绍的，因此又重新写了一篇介绍Bash的语法：[Bash脚本DLC：Bash语法和URL检测脚本实例](https://blackdn.github.io/2023/09/26/Bash-Grammar-2023/)，并且用的脚本例子更简单，算是本篇的DLC吧。  
推荐大家把两篇bash的文章结合起来看捏。
## Shell 和 Bash
...
一些常见的环境变量和特殊变量可见这里：[Linux变量](https://blackdn.github.io/2023/09/26/Bash-Grammar-2023/#%E5%8F%98%E9%87%8F)  
这里还有一些变量是可以在脚本内部使用的：
