...
我也懒得分那么细，所以 Tag 就简单给一个[Linux](https://blackdn.github.io/tags/#Linux)吧，下面也简称`Linux命令`好了。  
...
更新：因为这篇文章对 Bash 语法涉及甚少，涉及的知识都是为了实现实例的脚本而介绍的，因此又重新写了一篇介绍 Bash 的语法：[Bash 脚本 DLC：Bash 语法和 URL 检测脚本实例](https://blackdn.github.io/2023/09/26/Bash-Grammar-2023/)，并且用的脚本例子更简单，算是本篇的 DLC 吧。  
...
一些常见的环境变量和特殊变量可见这里：[Linux 变量](https://blackdn.github.io/2023/09/26/Bash-Grammar-2023/#%E5%8F%98%E9%87%8F)  
这里还有一些变量是可以在脚本内部使用的：
