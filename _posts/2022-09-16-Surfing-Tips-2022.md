...
**MarkText**是纯开源项目，并且是由国人开发的，有兴趣的话你还行自己去提交Pull Request，为它的发展献出一分力。  我倒是去提了个Issue哈哈。
