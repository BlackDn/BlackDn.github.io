...
仿射密码为单表加密的一种，简单来说就是对26个字母编号，然后根据映射函数将编号进行变化，然后重新转为字母。  
字母和编号的对应很简答，通常是对a-z进行0-25对应编号，难点在于映射函数，包括加密函数和解密函数  
...
其实也没啥，就是26个字母有各自的写法，可以看成一种新的语言  
