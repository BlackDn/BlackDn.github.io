...
然后针对考试整理一波...
## 考试要看的
1. [1.2.1 软件工程定义（了解）](#1-瀑布模型)  
2. [2.1 基于计算机的系统（了解）](#21-基于计算机的系统了解)  
3. [2.2 系统工程的任务（理解）](#22-系统工程的任务理解)
4. [2.3 可行性分析（了解）](/#23-可行性分析了解)
...
#### 15.1 软件维护
##### 概念（了解）
1. 定义：交付后，修改软件系统或部件以排除故障、改进性能或其他属性、适应环境的过程  
2. 分类  
...
```
2. 扩展的功能点度量：信息域中增加算法特征，使用特征点度量
3. 基于规模与居于功能度量的比较：代码行和功能点的关系依赖于实现软件采用的程序设计语言和设计质量
