---
layout: post
title: HarmonyOS：鸿蒙简介和 ArkTS 语言
...
因此，如果你之前接触过安卓移动开发（Java/Kotlin），那么你能很快上手ArkTS；如果你之前接触过前端开发（JS/TS），那么你能很快上手ArkTS；如果你之前接触过如 React Native 的跨平台开发框架，那么你能更快上手ArkTS。

接下来我们简单看一下 `ArkTS` 的基本语法，一些和 JS/TS 相类似的语法就跳过了
...
3. [学习ArkTS语言](https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/learning-arkts)
